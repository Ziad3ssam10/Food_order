...
import com.example.demo.Models.Delievry_Staff;
...
public class addadmin implements Initializable {
    ...
    public void add_admin() {
        try {
            int check = Main.moderators.get(Main.adminidx).Register(firstname_fild.getText(), email_fild.getText(), pass_fild.getText(), phonenum_fild.getText());
            if (check == 1) {
