...
public class addrestaurant implements Initializable {
    ...
    public void addrest() {
        ...
        if (gov_selector.getValue() == null || area_selector.getValue() == null || restname_fild1.getText()=="") {
            ...
            try {
                ...
                Main.moderators.get(Main.adminidx).Add_Resturant(restname_fild1.getText().toLowerCase(),area_selector.getSelectionModel().getSelectedItem(),gov_selector.getSelectionModel().getSelectedItem(),idx_area,idx_gov);
    ...
    public void additem() {
        ...
        success_lbl2.setVisible(false);
        Error_lbl2.setVisible(false);
        if (itemname_fild.getText()=="" || type_fild.getText()=="" || price_fild.getText()=="") {
