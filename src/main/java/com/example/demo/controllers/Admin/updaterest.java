...
public class updaterest implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        gov_idx=Governorate.get_index(resturant.get_Governorate());
        area_idx=Area.get_index(resturant.get_area(),gov_idx);
        rest_idx=Resturant.get_index(resturant.get_name(), gov_idx,area_idx);
        ...
        if (!resturant.getFood_items().isEmpty()){
            ...
            viewitems_table.setItems(resturant.getFood_items());
        }
        if (!resturant.getCategory().isEmpty()){
            ...
            viewcate_table.setItems(resturant.getCategory());
        }
    ...
    public void remove_categ() {
        if (remo_catogery_fild1.getText().equals("") || remo_catogery_fild1.getText().isEmpty()){
            errorcateg_lbl.setVisible(true);
        }
        else {
            errorcateg_lbl.setVisible(false);
            if(Main.capitals.get(gov_idx).getArea_list().get(area_idx).getResturantlist().get(rest_idx).Remove_category(remo_catogery_fild1.getText())==0){
                errorcateg_lbl.setVisible(true);
            }
            else {
                errorcateg_lbl.setVisible(false);
    ...
    public void add_categ() {
        if (add_catogery_fild.getText().equals("") || add_catogery_fild.getText().isEmpty()){
            add_categ_lbl.setVisible(true);
        }
        else {
            add_categ_lbl.setVisible(false);
            Main.capitals.get(gov_idx).getArea_list().get(area_idx).getResturantlist().get(rest_idx).add_category(add_catogery_fild.getText());
            resturant=Main.capitals.get(gov_idx).getArea_list().get(area_idx).getResturantlist().get(rest_idx);
    ...
    public void remove_item(){
        if (remove_itemname_fild.getText().equals("") || remove_itemname_fild.getText().isEmpty()){
         ...
         error_add_item_lbl.setVisible(false);
            ...
            if(Main.capitals.get(gov_idx).getArea_list().get(area_idx).getResturantlist().get(rest_idx).RemoveItem(remove_itemname_fild.getText())==0){
                error_remo_item_lbl.setVisible(true);
                error_add_item_lbl.setVisible(false);
            }
            else {
    ...
    public void add_item(){
        if (add_itemname_fild.getText().equals("") || add_itemname_fild.getText().isEmpty() ||add_type_fild.getText().equals("") || add_type_fild.getText().isEmpty() || add_price_fild.getText().equals("") || add_price_fild.getText().isEmpty()){
