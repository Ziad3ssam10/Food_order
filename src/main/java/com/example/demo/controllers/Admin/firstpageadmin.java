...
import com.example.demo.controllers.Customer.restaurantview;
...
public class firstpageadmin implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        name_admin_lbl.setText(Main.moderators.get(Main.customeridx).get_LName());
        ...
        if (allrest.isEmpty()) {
            ...
            gover_column.setCellValueFactory(cellData -> cellData.getValue().getGovernorateProperty());
