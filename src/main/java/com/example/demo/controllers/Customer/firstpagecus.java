...
public class firstpagecus implements Initializable {
    ...
    public void change_gov(){
        try {
            Main.capitals.get(Main.governoridx).getCustomers().get(Main.customeridx).setGovernorate(gov_changeselector.getSelectionModel().getSelectedItem());
            ...
            Main.governoridx = Governorate.get_index(gov_changeselector.getSelectionModel().getSelectedItem());
