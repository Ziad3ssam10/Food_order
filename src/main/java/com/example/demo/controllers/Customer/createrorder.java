...
public class createrorder implements Initializable {
    ...
    public void get_index_area(String area) {
        for (int i=0;i<Main.capitals.get(Main.governoridx).getArea_list().size();i++) {
            if (Main.capitals.get(Main.governoridx).getArea_list().get(i).getName().equals(area)) {
                idx_area = i;
                break;
            }
        }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Governorate_column.setCellValueFactory(cellData -> cellData.getValue().getGovernorateProperty());
        namerest_column.setCellValueFactory(cellData -> cellData.getValue().getNameProperty());
        area_column.setCellValueFactory(cellData -> cellData.getValue().getAreaProperty());
...
public void open_rest() {
    ...
    public void tofindarea() {
        ...
        Restaurants=Main.capitals.get(Main.governoridx).getArea_list().get(idx_area).getResturantlist();
